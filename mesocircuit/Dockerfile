...
RUN pip --no-cache-dir install --no-deps git+https://github.com/LFPy/LFPy.git@v2.2.6

# --- Install hybridLFPy@nest3 ----
RUN pip --no-cache-dir install --no-deps git+https://github.com/INM-6/hybridLFPy.git@4254e56d581e9b1f48f696853c3d969c4e561d8b

# ---- Install additional dependencies ----
RUN pip --no-cache-dir install --no-deps git+https://github.com/NeuralEnsemble/parameters@b95bac2bd17f03ce600541e435e270a1e1c5a478
