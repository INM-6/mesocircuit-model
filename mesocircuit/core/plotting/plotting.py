...
class Plotting(base_class.BaseAnalysisPlotting):
    ...
    def plot_statistics_overview(self, gs, all_FRs, all_LVs, all_CCs, all_PSDs):
        """
        TODO
        """
        axes = [0] * 7
    ...
    def plot_spatial_snapshots(
        ...
        if (int(ticklabels[0]) == ticklabels[0] and int(ticklabels[1]) == ticklabels[1]):
    ...
    def plot_boxcharts(self, gs, data, xlabel='', ylabel='', xticklabels=True):
        """
        TODO
        """
        ax = plt.subplot(gs)
    ...
    def plotfunc_CCs_distance(self, ax, X, i, data, max_num_pairs=10000, markersize_scale=0.4, nblocks=3):
        """
        """
